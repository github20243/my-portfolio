            ...
            <ContentOverlay>
                ...
                <StyledCard>
                    <CardContent>
                        ...
                        >
                            {projectsData.title}{" "}
                            <span role="img" aria-label="frog" style={{ color: "red", marginLeft: "5px" }}>
                                ⚛
                            </span>
                        </StyledAnimeSiteText>
                        ...
                        <StyledStack direction="row" spacing={2} sx={{ marginTop: "20px", flexWrap: "wrap" }}>
                        ...
                        <StyledStackButton direction="row" spacing={2} sx={{ marginTop: "20px" }}>
                            <Button variant="contained" color="primary" href={projectsData.codeLink} sx={{ marginRight: "20px" }}>
                                Код
                            </Button>
                            <Button variant="contained" color="secondary" href={projectsData.demoLink}>
                                Демонстрация
                            </Button>
                        </StyledStackButton>
                    </CardContent>
