    ...
    <StyledContainer>
      ...
      <DesktopMenu>
        {buttons.map((button, index) => (
          <StyledButton key={button.href} href={button.href} index={index} selected={location.pathname === button.href}>
            {button.icon}
...
const StyledButton = styled(Button)<{ index?: number; selected?: boolean }>(({ theme, index = 0, selected }) => ({
